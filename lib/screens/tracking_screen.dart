...
class _TrackingScreenState extends State<TrackingScreen> {
  ...
  List<double> _weeklyHistory = [
    ...
    0.8,
    0.0
  ]; // آخر عنصر يمثل اليوم الحالي ليرتبط بالمنحنى
          ...
          decoration: InputDecoration(
            ...
            enabledBorder: OutlineInputBorder(
                borderSide: BorderSide(
                    color:
                        isDarkMode ? Colors.blueGrey.shade700 : Colors.grey)),
            ...
            onPressed: () {
              if (taskController.text.isNotEmpty) {
                setState(() {
                  ...
                  // تحديث المنحنى فوراً
                  _weeklyHistory[_weeklyHistory.length - 1] =
                      _calculateProgress;
                });
                _saveTasks();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        backgroundColor:
            isDarkMode ? const Color(0xFF1E293B) : Colors.blue.shade700,
      ...
      floatingActionButton: Padding(
        padding: const EdgeInsets.only(
            bottom: 60.0), // رفع الزر قليلاً لكي لا يغطي عليه زر التأكيد
            ...
            LineChartBarData(
              ...
              dotData: FlDotData(
                ...
                checkToShowDot: (spot, barData) =>
                    spot.x == 6, // تمييز نقطة اليوم الحالي فقط
        ...
        return Dismissible(
          ...
          onDismissed: (direction) {
            setState(() {
              ...
              _weeklyHistory[_weeklyHistory.length - 1] =
                  _calculateProgress; // تحديث المنحنى بعد الحذف
            });
            _saveTasks();
          },
          child: Container(
            ...
            child: CheckboxListTile(
              title: Text(
                ...
                style: TextStyle(
                  ...
                  decoration:
                      TextDecoration.none, // الكتابة تظل نظيفة بدون خط مشطوب
                ),
              ),
              value: isDone,
              activeColor:
            ...
            SnackBar(
              content: Row(
                children: [
                  ...
                  Text(
                      "Weigo Progress Saved! (${(_calculateProgress * 100).toInt()}% Done)"),
                ],
              ),
              backgroundColor:
                  isDarkMode ? Colors.blue.shade600 : Colors.green.shade700,
